...
const glbVehicleDefs = [
  ...
  { key: 'suv-luxury', kind: 'car', fitLength: 2.97 },
  { key: 'van', kind: 'car', fitLength: 3.19 },
  { key: 'delivery', kind: 'car', fitLength: 3.19 },
  { key: 'ambulance', kind: 'tall', fitLength: 3.2 },
  { key: 'truck', kind: 'tall', fitLength: 4.08 },
  { key: 'firetruck', kind: 'tall', fitLength: 4.32 },
  { key: 'garbage-truck', kind: 'tall', fitLength: 4.2 },
